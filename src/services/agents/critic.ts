...
// Aligned with planner.ts MAX_ITERATIONS_CORRESPONDENT_CRITIC = 1. With the
// 2026-05-01 Architect decision to skip the iter-1 retry on thin-data drafts,
// a first-iter "reject" verdict here must escalate immediately — otherwise
// the draft lands at status=needs_revision with no follow-up scheduled, and
// it sits forever as a zombie that still counts toward the user's queue cap.
// Observed via Anya's 3 cold drafts stuck since 2026-05-06.
