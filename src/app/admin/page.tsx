...
export default function AdminPage() {
  ...
  async function sendWelcome(userId: string, opts?: { postUpdate?: boolean }) {
    ...
    const confirmMsg = postUpdate
      ...
      : "Send the welcome email to this user? Mints a fresh setup link (48h TTL).";
        ...
        <div className="border-t border-[#D9CFB5] p-4 text-xs space-y-2">
          ...
          <div className="pt-3 border-t border-[#EAE3D2] flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              title="Mints a fresh setup token (48h) and emails the welcome body. Use for users who never got the welcome (e.g. created outside the approve flow)."
            >
