...
export default function HomePage() {
  ...
  // Already has profile — go to pipeline
  if (session && profile) {
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className={`rounded-full px-2 py-0.5 text-[10px] font-medium ${
                      isProfileShared ? "bg-emerald-50 text-emerald-600" : "bg-slate-100 text-slate-400"
                    }`}>
                  ...
                  <p className="text-xs text-slate-500">
                    {isProfileShared
                      ? "Your analyzed resume will be visible to leaderboard members who also opted in."
                      : "Your resume stays private. You won't see other members' resumes either."}
                  </p>
                </div>
                <button
                  type="button"
