import { WELCOME_SETUP_TOKEN_TTL_LABEL } from "./setup-token";
...
Link expires in ${WELCOME_SETUP_TOKEN_TTL_LABEL}. If it expires, request a new one at:
${p.forgotPath}
